...
const propTypes = {
  ...
  openProjectsData: PropTypes.arrayOf(PropTypes.shape({})).isRequired,
};

const PAGE_TITLE = 'Open Projects';

const OpenProjectsPage = ({ setHeaderTitle, openProjectsData }) => {
  let renderContent;
  ...
  if (openProjectsData.length) {
    renderContent = (
      <Grid container spacing={5}>
        {
          openProjectsData.map(data => (
